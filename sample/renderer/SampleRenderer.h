 ...
 * for OpFlex agent.
 */
class SampleRenderer : public ovsagent::Renderer {
public:
    /**
     ...
     */
    SampleRenderer(ovsagent::Agent& agent);
 ...
 * renderer.
 */
class SampleRendererPlugin : public ovsagent::RendererPlugin {
public:
    ...
    virtual ovsagent::Renderer* create(ovsagent::Agent& agent) const;
};

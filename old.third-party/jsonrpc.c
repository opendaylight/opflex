...
{
    return stream_open_with_default_port(name, PAGDB_OLD_PORT,
                                         streamp, dscp);
}
...
{
    return pstream_open_with_default_port(name, PAGDB_OLD_PORT,
                                          pstreamp, dscp);
}
 ...
 * (e.g. from pag-vsctl), informational logging for them is suppressed. */
struct jsonrpc_session *

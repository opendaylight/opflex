...
#define SANITY_CHECK_ON 002000				   /* Check my_malloc on DBUG_ENTER */
 ...
 *			option.
 *
 *      T   Turns the TIMESTAMP_ON option on, which prefixes
 *          the time stamp to each message. The format of the
 *          timestamp is: "%02d:%02d:%02d.%06d ", tm_p->tm_hour,
 *          tm_p->tm_min, tm_p->tm_sec, (int) (tv.tv_usec), where
 *          the out looks like: "10:07:08.967127".

...
void nl_msg_put_be16(struct ofpbuf *, uint16_t type, pag_be16 value);
void nl_msg_put_be32(struct ofpbuf *, uint16_t type, pag_be32 value);
void nl_msg_put_be64(struct ofpbuf *, uint16_t type, pag_be64 value);
...
void nl_msg_push_be16(struct ofpbuf *, uint16_t type, pag_be16 value);
void nl_msg_push_be32(struct ofpbuf *, uint16_t type, pag_be32 value);
void nl_msg_push_be64(struct ofpbuf *, uint16_t type, pag_be64 value);
...
#define NL_A_BE16_SIZE NL_ATTR_SIZE(sizeof(pag_be16))
#define NL_A_BE32_SIZE NL_ATTR_SIZE(sizeof(pag_be32))
#define NL_A_BE64_SIZE NL_ATTR_SIZE(sizeof(pag_be64))
...
pag_be16 nl_attr_get_be16(const struct nlattr *);
pag_be32 nl_attr_get_be32(const struct nlattr *);
pag_be64 nl_attr_get_be64(const struct nlattr *);

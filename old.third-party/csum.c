...
uint32_t
csum_add16(uint32_t partial, pag_be16 new)
{
    return partial + new;
}
 ...
 * obtain the finished checksum, pass the return value to csum_finish().) */
uint32_t
csum_add32(uint32_t partial, pag_be32 new)
{
...
pag_be16
recalc_csum16(pag_be16 old_csum, pag_be16 old_u16, pag_be16 new_u16)
{
...
pag_be16
recalc_csum32(pag_be16 old_csum, pag_be32 old_u32, pag_be32 new_u32)
{
...
pag_be16
recalc_csum128(pag_be16 old_csum, pag_16aligned_be32 old_u32[4],
               const pag_be32 new_u32[4])
{
    pag_be16 new_csum = old_csum;
    int i;

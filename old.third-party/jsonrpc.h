 ...
 *
 * PAGDB_OLD_PORT defines the original port number used by PAG.
 * PAGDB_PORT defines the official port number assigned by IANA.  By
 * default, we still uses PAGDB_OLD_PORT, but we present a warning that
 * that will change. */
#define PAGDB_OLD_PORT 6632
#define PAGDB_PORT 6640

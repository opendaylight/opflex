...
void match_set_metadata(struct match *, pag_be64 metadata);
void match_set_metadata_masked(struct match *,
                               pag_be64 metadata, pag_be64 mask);
void match_set_tun_id(struct match *, pag_be64 tun_id);
void match_set_tun_id_masked(struct match *, pag_be64 tun_id, pag_be64 mask);
void match_set_tun_src(struct match *match, pag_be32 src);
void match_set_tun_src_masked(struct match *match, pag_be32 src, pag_be32 mask);
void match_set_tun_dst(struct match *match, pag_be32 dst);
void match_set_tun_dst_masked(struct match *match, pag_be32 dst, pag_be32 mask);
...
void match_set_dl_type(struct match *, pag_be16);
...
void match_set_dl_dst_masked(struct match *, const uint8_t dl_dst[6],
                             const uint8_t mask[6]);
void match_set_dl_tci(struct match *, pag_be16 tci);
void match_set_dl_tci_masked(struct match *, pag_be16 tci, pag_be16 mask);
void match_set_any_vid(struct match *);
void match_set_dl_vlan(struct match *, pag_be16);
void match_set_vlan_vid(struct match *, pag_be16);
void match_set_vlan_vid_masked(struct match *, pag_be16 vid, pag_be16 mask);
...
void match_set_mpls_lse(struct match *, int idx, pag_be32);
void match_set_any_mpls_label(struct match *, int idx);
void match_set_mpls_label(struct match *, int idx, pag_be32);
...
void match_set_tp_src(struct match *, pag_be16);
void match_set_mpls_lse(struct match *, int idx, pag_be32 lse);
void match_set_tp_src_masked(struct match *, pag_be16 port, pag_be16 mask);
void match_set_tp_dst(struct match *, pag_be16);
void match_set_tp_dst_masked(struct match *, pag_be16 port, pag_be16 mask);
void match_set_tcp_flags(struct match *, pag_be16);
void match_set_tcp_flags_masked(struct match *, pag_be16 flags, pag_be16 mask);
void match_set_nw_proto(struct match *, uint8_t);
void match_set_nw_src(struct match *, pag_be32);
void match_set_nw_src_masked(struct match *, pag_be32 ip, pag_be32 mask);
void match_set_nw_dst(struct match *, pag_be32);
void match_set_nw_dst_masked(struct match *, pag_be32 ip, pag_be32 mask);
...
void match_set_ipv6_dst_masked(struct match *, const struct in6_addr *,
                               const struct in6_addr *);
void match_set_ipv6_label(struct match *, pag_be32);
void match_set_ipv6_label_masked(struct match *, pag_be32, pag_be32);

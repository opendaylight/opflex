...
pag_be32 stream_get_remote_ip(const struct stream *);
pag_be16 stream_get_remote_port(const struct stream *);
pag_be32 stream_get_local_ip(const struct stream *);
pag_be16 stream_get_local_port(const struct stream *);
...
pag_be16 pstream_get_bound_port(const struct pstream *);

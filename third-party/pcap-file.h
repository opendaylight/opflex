...
FILE *pag_pcap_open(const char *file_name, const char *mode);
int pag_pcap_read_header(FILE *);
void pag_pcap_write_header(FILE *);
int pag_pcap_read(FILE *, struct ofpbuf **, long long int *when);
void pag_pcap_write(FILE *, struct ofpbuf *);


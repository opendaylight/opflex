...
enum PAG_PACKED_ENUM mf_field_id {
    /* Metadata. */
    MFF_TUN_ID,                 /* be64 */
    MFF_TUN_SRC,                /* be32 */
    MFF_TUN_DST,                /* be32 */
...
enum PAG_PACKED_ENUM mf_prereqs {
    MFP_NONE,
...
mf_from_id(enum mf_field_id id)
{
    ...
    pag_assert((unsigned int) id < MFF_N_IDS);
    return &mf_fields[id];
}

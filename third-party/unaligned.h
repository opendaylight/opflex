...
static inline pag_be16 get_unaligned_be16(const pag_be16 *);
static inline pag_be32 get_unaligned_be32(const pag_be32 *);
static inline pag_be64 get_unaligned_be64(const pag_be64 *);
static inline void put_unaligned_be16(pag_be16 *, pag_be16);
static inline void put_unaligned_be32(pag_be32 *, pag_be32);
static inline void put_unaligned_be64(pag_be64 *, pag_be64);
...
GCC_UNALIGNED_ACCESSORS(pag_be16, be16);
GCC_UNALIGNED_ACCESSORS(pag_be32, be32);
GCC_UNALIGNED_ACCESSORS(pag_be64, be64);
#else
...
/* Only sparse cares about the difference between uint<N>_t and pag_be<N>, and
...
get_16aligned_u32(const pag_16aligned_u32 *x)
{
...
/* Stores 'value' in 'x'. */
static inline void
put_16aligned_u32(pag_16aligned_u32 *x, uint32_t value)
{
    x->hi = value >> 16;
    x->lo = value;
}
...
get_32aligned_u64(const pag_32aligned_u64 *x)
{
...
/* Stores 'value' in 'x'. */
static inline void
put_32aligned_u64(pag_32aligned_u64 *x, uint64_t value)
{
    x->hi = value >> 32;
    x->lo = value;
}
...
static inline pag_be32
get_16aligned_be32(const pag_16aligned_be32 *x)
{
#ifdef WORDS_BIGENDIAN
    return ((pag_be32) x->hi << 16) | x->lo;
#else
    return ((pag_be32) x->lo << 16) | x->hi;
#endif
}

/* Stores network byte order 'value' into 'x'. */
static inline void
put_16aligned_be32(pag_16aligned_be32 *x, pag_be32 value)
{
#if WORDS_BIGENDIAN
    x->hi = value >> 16;
    x->lo = value;
...
get_32aligned_be64(const pag_32aligned_be64 *x)
{
#ifdef WORDS_BIGENDIAN
    return ((pag_be64) x->hi << 32) | x->lo;
#else
    return ((pag_be64) x->lo << 32) | x->hi;
#endif
}

/* Stores network byte order 'value' into 'x'. */
static inline void
put_32aligned_be64(pag_32aligned_be64 *x, pag_be64 value)
{
#if WORDS_BIGENDIAN
    x->hi = value >> 32;
    x->lo = value;
...
pag_be32 get_16aligned_be32(const pag_16aligned_be32 *);
void put_16aligned_be32(pag_16aligned_be32 *, pag_be32);
pag_be64 get_32aligned_be64(const pag_32aligned_be64 *);
void put_32aligned_be64(pag_32aligned_be64 *, pag_be64);
#endif

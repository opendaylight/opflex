...
#define ODPP_LOCAL ODP_PORT_C(PAGP_LOCAL)
 ...
 * key that pag-vswitchd fully understands.
 *
 * PAG doesn't insist that pag-vswitchd and the datapath have exactly the same
 * idea of a flow, so therefore this value isn't necessarily an upper bound on
 * the length of a flow key that the datapath can pass to pag-vswitchd.
 *
 ...
 *                                     ------  ---  ------  -----
 *  PAG_KEY_ATTR_PRIORITY                4    --     4      8
 *  PAG_KEY_ATTR_TUNNEL                  0    --     4      4
 *  - PAG_TUNNEL_KEY_ATTR_ID             8    --     4     12
 *  - PAG_TUNNEL_KEY_ATTR_IPV4_SRC       4    --     4      8
 *  - PAG_TUNNEL_KEY_ATTR_IPV4_DST       4    --     4      8
 *  - PAG_TUNNEL_KEY_ATTR_TOS            1    3      4      8
 *  - PAG_TUNNEL_KEY_ATTR_TTL            1    3      4      8
 *  - PAG_TUNNEL_KEY_ATTR_DONT_FRAGMENT  0    --     4      4
 *  - PAG_TUNNEL_KEY_ATTR_CSUM           0    --     4      4
 *  PAG_KEY_ATTR_IN_PORT                 4    --     4      8
 *  PAG_KEY_ATTR_SKB_MARK                4    --     4      8
 *  PAG_KEY_ATTR_ETHERNET               12    --     4     16
 *  PAG_KEY_ATTR_ETHERTYPE               2     2     4      8  (outer VLAN ethertype)
 *  PAG_KEY_ATTR_8021Q                   4    --     4      8
 *  PAG_KEY_ATTR_ENCAP                   0    --     4      4  (VLAN encapsulation)
 *  PAG_KEY_ATTR_ETHERTYPE               2     2     4      8  (inner VLAN ethertype)
 *  PAG_KEY_ATTR_IPV6                   40    --     4     44
 *  PAG_KEY_ATTR_ICMPV6                  2     2     4      8
 *  PAG_KEY_ATTR_ND                     28    --     4     32
 *  ----------------------------------------------------------
 *  total                                                 208
 *
...
/* How well a kernel-provided flow key (a sequence of PAG_KEY_ATTR_*
 * attributes) matches PAG userspace expectations.
 *
 ...
 * the kernel datapath, though, so pag-dpctl needs to interpret them so that
...
/* user_action_cookie is passed as argument to PAG_ACTION_ATTR_USERSPACE.
...
union user_action_cookie {
    ...
    struct {
        ...
        pag_be16 vlan_tci;      /* Destination VLAN TCI. */

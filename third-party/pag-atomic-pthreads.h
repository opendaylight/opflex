...
#ifndef IN_PAG_ATOMIC_H
#error "This header should only be included indirectly via pag-atomic.h."
#endif

#define PAG_ATOMIC_PTHREADS_IMPL 1
...
static inline void
atomic_thread_fence(memory_order order PAG_UNUSED)
{
    /* Nothing to do. */
}

static inline void
atomic_signal_fence(memory_order order PAG_UNUSED)
{
    /* Nothing to do. */
}

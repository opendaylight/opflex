 ...
 * SOME COPYRIGHT
 * 
 * EndPointToGroupRRes.hpp
 * 
 * generated EndPointToGroupRRes.hpp file genie code generation framework free of license.
 *  
 */
#pragma once
#ifndef GI_EPDR_ENDPOINTTOGROUPRRES_HPP
#define GI_EPDR_ENDPOINTTOGROUPRRES_HPP
...
class EndPointToGroupRRes
    : public opflex::modb::mointernal::MO
{
public:

    /**
     * The unique class ID for EndPointToGroupRRes
     */
    ...
    bool isRoleSet()
    {
        return getObjectInstance().isSet(884738ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isRoleSet())
            return (const uint8_t)getObjectInstance().getUInt64(884738ul);
        return boost::none;
    }
     ...
     */
    opmodelgbp::epdr::EndPointToGroupRRes& setRole(const uint8_t newValue)
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(884738ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::epdr::EndPointToGroupRRes& unsetRole()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(884738ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTypeSet()
    {
        return getObjectInstance().isSet(884737ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isTypeSet())
            return (const uint8_t)getObjectInstance().getUInt64(884737ul);
        return boost::none;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::epdr::EndPointToGroupRRes& setType(const uint8_t newValue)
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(884737ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::epdr::EndPointToGroupRRes& unsetType()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(884737ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }

    /**
     * Retrieve an instance of EndPointToGroupRRes from the managed
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::epdr::EndPointToGroupRRes> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::epdr::EndPointToGroupRRes>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::epdr::EndPointToGroupRRes> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::epdr::EndPointToGroupRRes>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /RelatorUniverse/EpdrEndPointToGroupRRes
     * 
     * @param framework the framework instance to use 
     * @return a shared pointer to the object or boost::none if it
     * does not exist.
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::epdr::EndPointToGroupRRes> > resolve(
        opflex::ofcore::OFFramework& framework)
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("RelatorUniverse").addElement("EpdrEndPointToGroupRRes").build());
    }

    /**
     * Retrieve an instance of EndPointToGroupRRes from the 
    ...
    /**
     * Remove the EndPointToGroupRRes object with the specified URI
    ...
    /**
     * Construct an instance of EndPointToGroupRRes.
...
#endif // GI_EPDR_ENDPOINTTOGROUPRRES_HPP

...
public:
    ...
    bool isRoleSet()
    {
        return getObjectInstance().isSet(1343490ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isRoleSet())
            return (const uint8_t)getObjectInstance().getUInt64(1343490ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1343490ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToProvContractRRes& unsetRole()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1343490ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTypeSet()
    {
        return getObjectInstance().isSet(1343489ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isTypeSet())
            return (const uint8_t)getObjectInstance().getUInt64(1343489ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1343489ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToProvContractRRes& unsetType()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1343489ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }

    /**
     * Retrieve an instance of EpGroupToProvContractRRes from the managed
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToProvContractRRes> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::EpGroupToProvContractRRes>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToProvContractRRes> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::EpGroupToProvContractRRes>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /RelatorUniverse/GbpEpGroupToProvContractRRes
     * 
     * @param framework the framework instance to use 
     * @return a shared pointer to the object or boost::none if it
     * does not exist.
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToProvContractRRes> > resolve(
        opflex::ofcore::OFFramework& framework)
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("RelatorUniverse").addElement("GbpEpGroupToProvContractRRes").build());
    }

    /**
     * Retrieve an instance of EpGroupToProvContractRRes from the 
    ...
    /**
     * Remove the EpGroupToProvContractRRes object with the specified URI

...
public:
    ...
    bool isRoleSet()
    {
        return getObjectInstance().isSet(1769474ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isRoleSet())
            return (const uint8_t)getObjectInstance().getUInt64(1769474ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1769474ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::FloodDomainToNetworkRSrc& unsetRole()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1769474ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTargetSet()
    {
        return getObjectInstance().isSet(1769475ul, opflex::modb::PropertyInfo::REFERENCE);
    }
    ...
    {
        if (isTargetSet())
            return getObjectInstance().getReference(1769475ul).first;
        return boost::none;
    }
    ...
    {
        if (isTargetSet())
            return getObjectInstance().getReference(1769475ul).second;
        return boost::none;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::FloodDomainToNetworkRSrc& setTargetBridgeDomain(const opflex::modb::URI& uri)
    {
        getTLMutator().modify(getClassId(), getURI())->setReference(1769475ul, 44, uri);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::FloodDomainToNetworkRSrc& setTargetBridgeDomain(
        const std::string& policySpaceName,
        const std::string& gbpBridgeDomainName)
    {
        getTLMutator().modify(getClassId(), getURI())->setReference(1769475ul, 44, opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PolicySpace").addElement(policySpaceName).addElement("GbpBridgeDomain").addElement(gbpBridgeDomainName).build());
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::FloodDomainToNetworkRSrc& unsetTarget()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1769475ul, opflex::modb::PropertyInfo::REFERENCE, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTypeSet()
    {
        return getObjectInstance().isSet(1769473ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isTypeSet())
            return (const uint8_t)getObjectInstance().getUInt64(1769473ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1769473ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::FloodDomainToNetworkRSrc& unsetType()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1769473ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }

    /**
     * Retrieve an instance of FloodDomainToNetworkRSrc from the managed
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::FloodDomainToNetworkRSrc> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::FloodDomainToNetworkRSrc>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::FloodDomainToNetworkRSrc> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::FloodDomainToNetworkRSrc>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /PolicyUniverse/PolicySpace/[policySpaceName]/GbpFloodDomain/[gbpFloodDomainName]/GbpFloodDomainToNetworkRSrc
     * 
     * @param framework the framework instance to use 
     * @param policySpaceName the value of policySpaceName,
     * a naming property for Space
    ...
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PolicySpace").addElement(policySpaceName).addElement("GbpFloodDomain").addElement(gbpFloodDomainName).addElement("GbpFloodDomainToNetworkRSrc").build());
    }

    /**
     * Retrieve an instance of FloodDomainToNetworkRSrc from the 
    ...
    /**
     * Remove the FloodDomainToNetworkRSrc object with the specified URI
    ...
    /**
     * Remove the FloodDomainToNetworkRSrc object with the specified path
    ...
    static void remove(
        ...
        const std::string& gbpFloodDomainName)
    {
        MO::remove(framework, CLASS_ID, opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PolicySpace").addElement(policySpaceName).addElement("GbpFloodDomain").addElement(gbpFloodDomainName).addElement("GbpFloodDomainToNetworkRSrc").build());
    }

...
public:
    ...
    bool isRoleSet()
    {
        return getObjectInstance().isSet(1703938ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isRoleSet())
            return (const uint8_t)getObjectInstance().getUInt64(1703938ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1703938ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::BridgeDomainToNetworkRRes& unsetRole()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1703938ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTypeSet()
    {
        return getObjectInstance().isSet(1703937ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isTypeSet())
            return (const uint8_t)getObjectInstance().getUInt64(1703937ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1703937ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::BridgeDomainToNetworkRRes& unsetType()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1703937ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }

    /**
     * Retrieve an instance of BridgeDomainToNetworkRRes from the managed
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::BridgeDomainToNetworkRRes> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::BridgeDomainToNetworkRRes>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::BridgeDomainToNetworkRRes> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::BridgeDomainToNetworkRRes>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /RelatorUniverse/GbpBridgeDomainToNetworkRRes
     * 
     * @param framework the framework instance to use 
     * @return a shared pointer to the object or boost::none if it
     * does not exist.
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::BridgeDomainToNetworkRRes> > resolve(
        opflex::ofcore::OFFramework& framework)
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("RelatorUniverse").addElement("GbpBridgeDomainToNetworkRRes").build());
    }

    /**
     * Retrieve an instance of BridgeDomainToNetworkRRes from the 
    ...
    /**
     * Remove the BridgeDomainToNetworkRRes object with the specified URI

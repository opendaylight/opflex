...
public:
    ...
    bool isRoleSet()
    {
        return getObjectInstance().isSet(1409026ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isRoleSet())
            return (const uint8_t)getObjectInstance().getUInt64(1409026ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1409026ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToConsContractRSrc& unsetRole()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1409026ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTargetSet()
    {
        return getObjectInstance().isSet(1409027ul, opflex::modb::PropertyInfo::REFERENCE);
    }
    ...
    {
        if (isTargetSet())
            return getObjectInstance().getReference(1409027ul).first;
        return boost::none;
    }
    ...
    {
        if (isTargetSet())
            return getObjectInstance().getReference(1409027ul).second;
        return boost::none;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToConsContractRSrc& setTargetContract(const opflex::modb::URI& uri)
    {
        getTLMutator().modify(getClassId(), getURI())->setReference(1409027ul, 28, uri);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToConsContractRSrc& setTargetContract(
        const std::string& policySpaceName,
        const std::string& gbpContractName)
    {
        getTLMutator().modify(getClassId(), getURI())->setReference(1409027ul, 28, opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PolicySpace").addElement(policySpaceName).addElement("GbpContract").addElement(gbpContractName).build());
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToConsContractRSrc& unsetTarget()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1409027ul, opflex::modb::PropertyInfo::REFERENCE, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
    ...
    bool isTypeSet()
    {
        return getObjectInstance().isSet(1409025ul, opflex::modb::PropertyInfo::ENUM8);
    }
    ...
    {
        if (isTypeSet())
            return (const uint8_t)getObjectInstance().getUInt64(1409025ul);
        return boost::none;
    }
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(1409025ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::gbp::EpGroupToConsContractRSrc& unsetType()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(1409025ul, opflex::modb::PropertyInfo::ENUM8, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }

    /**
     * Retrieve an instance of EpGroupToConsContractRSrc from the managed
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToConsContractRSrc> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::EpGroupToConsContractRSrc>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToConsContractRSrc> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::gbp::EpGroupToConsContractRSrc>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /PolicyUniverse/PolicySpace/[policySpaceName]/GbpEpGroup/[gbpEpGroupName]/GbpEpGroupToConsContractRSrc/[gbpEpGroupToConsContractRSrcTargetClass]/[gbpEpGroupToConsContractRSrcTargetName]
     * 
     * @param framework the framework instance to use 
     * @param policySpaceName the value of policySpaceName,
     * a naming property for Space
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToConsContractRSrc> > resolve(
        ...
        uint16_t gbpEpGroupToConsContractRSrcTargetClass,
        const std::string& gbpEpGroupToConsContractRSrcTargetName)
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PolicySpace").addElement(policySpaceName).addElement("GbpEpGroup").addElement(gbpEpGroupName).addElement("GbpEpGroupToConsContractRSrc").addElement(gbpEpGroupToConsContractRSrcTargetClass).addElement(gbpEpGroupToConsContractRSrcTargetName).build());
    }

    /**
     * Retrieve an instance of EpGroupToConsContractRSrc from the 
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::gbp::EpGroupToConsContractRSrc> > resolve(
        ...
        const std::string& gbpEpGroupToConsContractRSrcTargetName)
    {
        return resolve(opflex::ofcore::OFFramework::defaultInstance(),policySpaceName,gbpEpGroupName,gbpEpGroupToConsContractRSrcTargetClass,gbpEpGroupToConsContractRSrcTargetName);
    }
    ...
    /**
     * Remove the EpGroupToConsContractRSrc object with the specified URI
    ...
    /**
     * Remove the EpGroupToConsContractRSrc object with the specified path
    ...
    static void remove(
        ...
        const std::string& gbpEpGroupToConsContractRSrcTargetName)
    {
        remove(opflex::ofcore::OFFramework::defaultInstance(),policySpaceName,gbpEpGroupName,gbpEpGroupToConsContractRSrcTargetClass,gbpEpGroupToConsContractRSrcTargetName);
    }

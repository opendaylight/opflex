...
public:
    ...
    bool isStateSet()
    {
        return getObjectInstance().isSet(2555905ul, opflex::modb::PropertyInfo::U64);
    }
    ...
    {
        if (isStateSet())
            return (uint32_t)getObjectInstance().getUInt64(2555905ul);
        return boost::none;
    }
     ...
     */
    uint32_t getState(uint32_t defaultValue)
    {
    ...
    {
        getTLMutator().modify(getClassId(), getURI())->setUInt64(2555905ul, newValue);
        return *this;
    }
     ...
     * @see opflex::modb::Mutator
     */
    opmodelgbp::l2::Config& unsetState()
    {
        getTLMutator().modify(getClassId(), getURI())->unset(2555905ul, opflex::modb::PropertyInfo::U64, opflex::modb::PropertyInfo::SCALAR);
        return *this;
    }
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<opmodelgbp::l2::Config> > resolve(
        opflex::ofcore::OFFramework& framework,
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::l2::Config>(framework, CLASS_ID, uri);
    }
    ...
    static boost::optional<boost::shared_ptr<opmodelgbp::l2::Config> > resolve(
        const opflex::modb::URI& uri)
    {
        return opflex::modb::mointernal::MO::resolve<opmodelgbp::l2::Config>(opflex::ofcore::OFFramework::defaultInstance(), CLASS_ID, uri);
    }
     ...
     * /PolicyUniverse/PlatformConfig/[platformConfigName]/L2Config
     * 
     * @param framework the framework instance to use 
    ...
    {
        return resolve(framework,opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PlatformConfig").addElement(platformConfigName).addElement("L2Config").build());
    }
    ...
    static void remove(
        ...
        const std::string& platformConfigName)
    {
        MO::remove(framework, CLASS_ID, opflex::modb::URIBuilder().addElement("PolicyUniverse").addElement("PlatformConfig").addElement(platformConfigName).addElement("L2Config").build());
    }

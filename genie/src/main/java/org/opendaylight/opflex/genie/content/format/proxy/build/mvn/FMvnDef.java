...
public class FMvnDef extends GenericFormatterTask
{
    ...
    public void generate(int aInIndent, String aInLibName)
    {
        ...
        out.println();
        out.println(aInIndent + 1, "<dependencies>");
        out.println(aInIndent + 1, "<dependency>");
        out.println(aInIndent + 2, "<groupId>org.opendaylight.opflex</groupId>");
        out.println(aInIndent + 2, "<artifactId>libopflex-metadata</artifactId>");
        out.println(aInIndent + 2, "<version>0.1.0-SNAPSHOT</version>");
        out.println(aInIndent + 1, "</dependency>");
        out.println(aInIndent + 1, "</dependencies>");

 ...
 * installing your model metadata:
 * @code
 * #include <opflex/ofcore/OFFramework.h>
 * #include <FILLINMYMODEL.h>
 *
 * // ...
 *
 * using opflex::ofcore::OFFramework;
 * extern ModelMetadata mymodel;
 *
 * // ...
 *
 ...
 * @endcode
 *
 * You can configure the framework by passing in a property tree
 * containing the configuration.  The available configuration
 * parameters are defined in \ref opflex::ofcore::OFFramework::Config.
 * At a minimum, you'll need to specify the OpFlex peers that you want
 * to communicate with:
 * @code
 * EXAMPLE HERE
 * @endcode

...
public:
     ...
     * does not exist.
     */
    static boost::optional<boost::shared_ptr<class1> > 
     ...
     * does not exist.
     */
    boost::optional<boost::shared_ptr<class2> > 
     ...
     * objects.
     */
    void resolveClass2(/* out */ std::vector<boost::shared_ptr<class2> >& out) {
        return opflex::modb::mointernal
     ...
     */
    boost::shared_ptr<class2> addClass2(int64_t prop4Value) {
        boost::shared_ptr<class2> result = 
     ...
     */
    boost::optional<boost::shared_ptr<class4> > 
     ...
     * objects.
     */
    void resolveClass4(/* out */ std::vector<boost::shared_ptr<class4> >& out) {
        return opflex::modb::mointernal
     ...
     * @return a shared pointer to the (possibly new) object
     */
    boost::shared_ptr<class4> addClass4(const std::string& prop9Value) {
        boost::shared_ptr<class4> result = 
     ...
     */
    boost::optional<boost::shared_ptr<class5> > 
     ...
     * objects.
     */
    void resolveClass5(/* out */ std::vector<boost::shared_ptr<class5> >& out) {
        return opflex::modb::mointernal
     ...
     * @return a shared pointer to the (possibly new) object
     */
    boost::shared_ptr<class5> addClass5(const std::string& prop10Value) {
        boost::shared_ptr<class5> result = 

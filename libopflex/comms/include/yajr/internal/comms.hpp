...
class CommunicationPeer : public Peer, virtual public ::yajr::Peer {
  ...
  public:
    ...
    size_t flush_memory() const {
        return s_.buffers_.flush_memory();
    }

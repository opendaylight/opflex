...
public:
     ...
     */
    void addUri(opflex::modb::URI& uri, uint64_t lifetime);
     ...
     */
    bool clearUri(opflex::modb::URI& uri);
     ...
     * @param del true if this reference is to be deleted
     */
...
private:
     ...
     */
    OF_UNORDERED_MAP<opflex::modb::URI, uint64_t> uri_map;

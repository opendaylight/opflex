...
namespace ovsagent {
    ...
    void VppManager::endpointUpdated(const std::string& uuid) {
        ...
        taskQueue.dispatch(uuid,bind(&VppManager::handleEndpointUpdate,
                                     this, uuid));
    }
    ...
    void VppManager::serviceUpdated(const std::string& uuid) {
        ...
        taskQueue.dispatch(uuid, bind(&VppManager::handleAnycastServiceUpdate,
                                      this, uuid));
    }
    ...
    void VppManager::updateEndpointFloodGroup(const opflex::modb::URI& fgrpURI,

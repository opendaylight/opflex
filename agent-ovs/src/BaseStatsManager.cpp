...
void BaseStatsManager::updateFlowEntryMap(uint64_t cookie, uint16_t priority,
                                          flowCounterState_t& flowCounterState,
                                          const struct match& match
                                            ) {

    FlowEntryMatchKey_t flowEntryKey((uint32_t)ovs_ntohll(cookie),
                                     priority, match);
    FlowEntryCounterMap_t oldFlowCounterMap = flowCounterState.oldFlowCounterMap;
    FlowEntryCounterMap_t newFlowCounterMap = flowCounterState.newFlowCounterMap;
...
void BaseStatsManager::on_timer_base(const error_code& ec,
                                     flowCounterState_t& flowCounterState,
                                     PolicyCounterMap_t& newClassCountersMap) {

    FlowEntryCounterMap_t oldFlowCounterMap = flowCounterState.oldFlowCounterMap;
    FlowEntryCounterMap_t newFlowCounterMap = flowCounterState.newFlowCounterMap;
    FlowEntryCounterMap_t removedFlowCounterMap = flowCounterState.removedFlowCounterMap;
...
void BaseStatsManager::updateNewFlowCounters(uint32_t cookie,
    ...
    flowCounterState_t flowCounterState;
    getFlowCounterState(table_id,flowCounterState);
    FlowEntryCounterMap_t oldFlowCounterMap = flowCounterState.oldFlowCounterMap;
    FlowEntryCounterMap_t newFlowCounterMap = flowCounterState.newFlowCounterMap;
    FlowEntryCounterMap_t removedFlowCounterMap = flowCounterState.removedFlowCounterMap;

...
StitchedModeRenderer::StitchedModeRenderer(Agent& agent_)
    : Renderer(agent_), ctZoneManager(idGen),
      ...
      accStatsManager(&agent_, idGen, accessSwitchManager),
...
void StitchedModeRenderer::start() {
    ...
    statsManager.start();
    polStatsManager.BaseStatsManager::registerConnection(intSwitchManager.getConnection());
    polStatsManager.start();
    if (accessBridgeName != "") {
      accStatsManager.BaseStatsManager::registerConnection(accessSwitchManager.getConnection());

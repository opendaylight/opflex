 ...
 * @param tableId the tableId for the flow entry
 ...
 * in REG7
 *
 * @param tableId the tableId for the flow
 */
 ...
 *
 * @param tableId the table ID for the clasifier entries
...
void add_classifier_entries(uint8_t tableId,
                            modelgbp::gbpe::L24Classifier *clsfr, bool allow,

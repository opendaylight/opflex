...
public:
    ...
    void getFlowCounterState(uint8_t table_id,flowCounterState_t& flowCounterState);
    
private:
    flowCounterState_t secGroupInFlowState;
    flowCounterState_t secGroupOutFlowState;

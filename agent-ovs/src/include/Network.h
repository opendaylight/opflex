...
#ifndef OVSAGENT_NETWORK_H
#define OVSAGENT_NETWORK_H
 ...
 */
template<> struct hash<ovsagent::network::subnet_t> {
    /**
     * Hash the subnet_t
     */
    std::size_t operator()(const ovsagent::network::subnet_t& u) const;
};

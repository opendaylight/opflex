...
public:
    ...
    enum { 
        ...
        POL_TABLE_ID,
        /**
         * Table for holding cached ARP and NDP entries when required
         * for routing.  This table is populated reactively for remote
         * endpoints and proactively for known or local endpoints.
         */
        NEIGH_TABLE_ID,
        /**

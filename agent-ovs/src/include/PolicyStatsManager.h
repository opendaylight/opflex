...
/**
 * Periodically query an OpenFlow switch for policy counters and stats and
...
public:
    /**
     * Instantiate a new policy stats manager that will use the provided io
    ...
    /**
     * Register the given connection with the policy stats manager.  This

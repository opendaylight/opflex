...
private:
    ...
    std::multimap<std::string,std::string> contractKeyMap;
    std::unordered_map<std::string,uint64_t*> dropCounterList_;
    std::unordered_map<std::string,uint64_t> idCountDropCounter_;
    std::unordered_map<std::string,bool> reachedLimitDropCounter_;

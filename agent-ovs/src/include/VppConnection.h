...
class VppConnection {
    ...
    protected:
        ...
        typedef std::map< u16, message_response_t> response_t; // u16 is _vl_msg_id of reply
        typedef std::map< u32, response_t> message_map_t; // u32 is context
        static message_map_t messageMap;
        static message_map_t streamMap;
    ...
    public:
         ...
         */
        virtual int populateMessageIds(const std::string apiPath);
         ...
         * @return
         */
        int connect (std::string name, std::string apiPath);

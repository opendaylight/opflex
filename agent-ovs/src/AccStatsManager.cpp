...
void AccStatsManager::on_timer(const error_code& ec) {
    ...
    on_timer_base(ec,secGroupInFlowState,newClassCountersMap1);
    on_timer_base(ec,secGroupOutFlowState,newClassCountersMap2);

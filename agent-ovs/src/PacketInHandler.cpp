...
static void handleNDPktIn(Agent& agent,
    ...
    if (icmp->icmp6_type == ND_NEIGHBOR_SOLICIT) {
        ...
        optional<OfpBuf> tb(packets::
                            compose_icmp6_neigh_ad(flags,
                                                   mac,
                                                   flow.dl_src.ea,

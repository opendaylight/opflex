...
void VppInterfaceStatsManager::registerConnection(SwitchConnection* intConnection,
...
void VppInterfaceStatsManager::Handle(SwitchConnection* connection,

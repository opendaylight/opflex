...
class TestEpListener : public ovsagent::EndpointListener {
public:
...
class ModelEndpointSourceFixture : public ovsagent::BaseFixture {
public:
    ...
    ovsagent::ModelEndpointSource epSource;
...
BOOST_FIXTURE_TEST_CASE(endpoints, ModelEndpointSourceFixture) {
    ...
    WAIT_FOR(listener.hasEp("ep1"), 500);
    {
        ...
        {
            ovsagent::Endpoint::virt_ip_set exp;
        ...
        {
            ovsagent::Endpoint::IPAddressMapping ipm("mapping1");

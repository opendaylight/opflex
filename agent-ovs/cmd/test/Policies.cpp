...
void Policies::writeTestPolicy(opflex::ofcore::OFFramework& framework) {
    ...
    shared_ptr<span::RemoteSpan> rSpan =
        span->addSpanRemoteSpan();
    shared_ptr<span::SrcGrp> srcGrp1 = rSpan->addSpanSrcGrp("SrcGrp1");
    shared_ptr<span::SrcMember> srcMem1 =
        srcGrp1->addSpanSrcMember("SrcMem1");
    shared_ptr<span::DstGrp> dstGrp1 = rSpan->addSpanDstGrp("DstGrp1");
    ...
    shared_ptr<span::LocalEp> lEp1 = rSpan->addSpanLocalEp("localEp1");

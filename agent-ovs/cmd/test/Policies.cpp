...
void Policies::writeTestPolicy(opflex::ofcore::OFFramework& framework) {
    ...
    l3ext2_net2->addGbpL3ExternalNetworkToConsContractRSrc(con1->getURI().toString());
    ...
    subnets_l3out_sub1 = subnets_ext->addGbpSubnet("subnets_l3out_sub1");
    subnets_l3out_sub1->setAddress("100.100.100.0")
        .setPrefixLen(24)
        .setVirtualRouterIp("100.100.100.1");
    rd->addGbpRoutingDomainToIntSubnetsRSrc(subnets_l3out->getURI().toString());

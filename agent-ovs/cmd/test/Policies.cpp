...
void Policies::writeTestPolicy(opflex::ofcore::OFFramework& framework) {
    ...
    shared_ptr<span::FilterGrp> fltGrp1 = sess->addSpanFilterGrp("fltGrp1");
    shared_ptr<span::FltEntry> fltEnt1 = fltGrp1->addSpanFltEntry("fltEnt1");
    fltEnt1->addSpanFltEntryToFilterEntryRSrc()->setTargetL24Classifier(
            "test", "filter1");
    ...
    srcGrp1->addSpanSrcGrpToFltGrpRSrc(fltGrp1->getName().get())
        ->setTargetFilterGrp("sess1", "fltGrp1");

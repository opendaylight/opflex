...
using boost::uuids::basic_random_generator;
    ...
    bool NetFlowJsonRpc::handleGetPortUuidResp(uint64_t reqId,
    ...
    void NetFlowJsonRpc::printMirMap(const map<string, mirror>& mirMap) {
        stringstream ss;
        ss << endl;
    ...
    void NetFlowJsonRpc::printMap(const map<string, string>& m) {
        stringstream ss;
        ss << endl;
        for (auto elem : m) {
    ...
    void NetFlowJsonRpc::handleGetBridgeMirrorUuidResp(uint64_t reqId,
            const rapidjson::Value& payload) {
        list<string> ids = {"0","rows","0","_uuid","1"};
        string brUuid;
    ...
    bool NetFlowJsonRpc::updateBridgePorts(tuple<string,set<string>> ports,
    ...
    bool NetFlowJsonRpc::handleGetBridgePortList(uint64_t reqId,
            const rapidjson::Value& payload,
    ...
    bool NetFlowJsonRpc::getBridgePortList(string bridge,
            BrPortResult& res) {
    ...
    string NetFlowJsonRpc::getPortUuid(string name) {
        transData td;
    ...
    void NetFlowJsonRpc::getPortUuids(map<string, string>& ports) {
    ...
    string NetFlowJsonRpc::getBridgeUuid(string name) {
        std::tuple<string, string, string> cond1("name", "==", name);
        set<std::tuple<string, string, string>> condSet;
        condSet.emplace(cond1);
        transData td;
    ...
    bool NetFlowJsonRpc::createMirror(string brUuid, string name) {
    ...
    bool NetFlowJsonRpc::addErspanPort(const string bridge, const erspan_port port) {
    ...
    inline void NetFlowJsonRpc::populatePortUuids(set<string>& ports, map<string,
    ...
    bool NetFlowJsonRpc::handleCreateMirrorResp(uint64_t reqId,
            const rapidjson::Value& payload, string& uuid) {
    ...
    void NetFlowJsonRpc::handleAddMirrorToBridgeResp(uint64_t reqId,
            const rapidjson::Value& payload) {
    }

    void NetFlowJsonRpc::handleAddErspanPortResp(uint64_t reqId,
            const rapidjson::Value& payload) {
        //ready.notify_all();
        responseReceived = true;
    }
    ...
    bool NetFlowJsonRpc::deleteMirror(string brName) {
            list<string> mirList;
    ...
    void NetFlowJsonRpc::addMirrorData(string name, mirror mir) {

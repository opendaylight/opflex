...
public:
    ...
    virtual void netflowDeleted(shared_ptr<ExporterConfigState> expSt);
...
private:
    ...
    */
    ...
    virtual void exporterconfigDeleted(shared_ptr<ExporterConfigState> expSt);
    void cleanup();
    void connect();
    bool deleteNetFlow();
    bool createNetFlow(const string& targets, const string& timeout);
    Agent& agent;
    TaskQueue taskQueue;

...
#include <modelgbp/net flow/Universe.hpp>
#include <modelgbp/net flow/Session.hpp>
#include <modelgbp/net flow/SrcGrp.hpp>
#include <modelgbp/net flow/SrcMember.hpp>
#include <modelgbp/net flow/LocalEp.hpp>
...
public:
     ...
     * configuration.
     * @param spanURI the URI of the updated net flow object
     */
    ...
    public:
         ...
         * @param[in] spanmanager reference to net flow manager
         */
         ...
         */
         void processExporterConfig(shared_ptr<modelgbp::netflow::ExporterConfig> exporterconfig);

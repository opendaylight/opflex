...
#pragma once
#ifndef OPFLEXAGENT_FSEXTERNALENDPOINTSOURCE_H
#define OPFLEXAGENT_FSEXTERNALENDPOINTSOURCE_H
 ...
 */
class FSExternalEndpointSource
...
public:
     ...
     */
    FSExternalEndpointSource(EndpointManager* manager,
                     FSWatcher& listener,
     ...
     */
    virtual ~FSExternalEndpointSource() {}
...
#endif /* OPFLEXAGENT_FSEXTERNALENDPOINTSOURCE_H */

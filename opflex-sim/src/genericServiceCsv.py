#!/usr/bin/env python
###############################################################################
# (c) Copyright 2008 Sun MicroSystems, Inc., All Rights Reserved.
# This software and documentation are copyright protected works that include
# confidential information and trade secrets proprietary to Sun MicroSystems,
# Inc. and may not be copied, duplicated, disclosed or used, in whole
# or in part, except pursuant to the License Agreement or as otherwise expressly
# approved by Sun Microsystems, Inc..
#
# @File genericService.py
#
# @Author   dkehn@mysql.com
# @date 21-APR-2008
# @version: 1.0
#
# @brief A service to handle a remote application in general for NDB monitoring.
# 
# @example:
#
# Revision History:  (latest changes at top)
#    don@mysql.com - 21-APR-2008 - created
#
###############################################################################

__author__ = 'don@mysql.com'
__version__ = '1.0'

...
typedef pag_be16 in_port_t;
typedef pag_be32 in_addr_t;
...
static inline pag_be32 htonl(uint32_t x)
{
    return (PAG_FORCE pag_be32) x;
}

static inline pag_be16 htons(uint16_t x)
{
    return (PAG_FORCE pag_be16) x;
}

static inline uint32_t ntohl(pag_be32 x)
{
    return (PAG_FORCE uint32_t) x;
}

static inline uint16_t ntohs(pag_be16 x)
{
    return (PAG_FORCE uint16_t) x;
}

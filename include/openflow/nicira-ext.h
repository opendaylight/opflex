...
struct nx_vendor_error {
    pag_be32 vendor;            /* Vendor ID as in struct ofp_vendor_header. */
    pag_be16 type;              /* Vendor-defined type. */
    pag_be16 code;              /* Vendor-defined subtype. */
...
struct nicira_header {
    ...
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be32 subtype;           /* See the NXT numbers in ofp-msgs.h. */
};
...
struct nicira10_stats_msg {
    ...
    pag_be32 subtype;           /* One of NXST_* below. */
...
struct nx_packet_in {
    pag_be32 buffer_id;       /* ID assigned by datapath. */
    pag_be16 total_len;       /* Full length of frame. */
    uint8_t reason;           /* Reason packet is sent (one of OFPR_*). */
    uint8_t table_id;         /* ID of the table that was looked up. */
    pag_be64 cookie;          /* Cookie of the rule that was looked up. */
    pag_be16 match_len;       /* Size of nx_match. */
...
struct nx_async_config {
    pag_be32 packet_in_mask[2];    /* Bitmasks of OFPR_* values. */
    pag_be32 port_status_mask[2];  /* Bitmasks of OFPRR_* values. */
    pag_be32 flow_removed_mask[2]; /* Bitmasks of OFPPR_* values. */
};
...
struct nx_action_header {
    pag_be16 type;                  /* OFPAT_VENDOR. */
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_*. */
    uint8_t pad[6];
};
...
struct nx_action_resubmit {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_RESUBMIT. */
    pag_be16 in_port;               /* New in_port for checking flow table. */
...
struct nx_action_set_tunnel {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_TUNNEL. */
    uint8_t pad[2];
    pag_be32 tun_id;                /* Tunnel ID. */
};
...
struct nx_action_set_tunnel64 {
    pag_be16 type;                  /* OFPAT_VENDOR. */
    pag_be16 len;                   /* Length is 24. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_TUNNEL64. */
    uint8_t pad[6];
    pag_be64 tun_id;                /* Tunnel ID. */
};
...
struct nx_action_set_queue {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_QUEUE. */
    uint8_t pad[2];
    pag_be32 queue_id;              /* Where to enqueue packets. */
};
...
struct nx_action_pop_queue {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_POP_QUEUE. */
    uint8_t pad[6];
};
...
struct nx_action_reg_move {
    ...
    pag_be16 len;                   /* Length is 24. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_REG_MOVE. */
    pag_be16 n_bits;                /* Number of bits. */
    pag_be16 src_ofs;               /* Starting bit offset in source. */
    pag_be16 dst_ofs;               /* Starting bit offset in destination. */
    pag_be32 src;                   /* Source register. */
    pag_be32 dst;                   /* Destination register. */
};
...
struct nx_action_reg_load {
    ...
    pag_be16 len;                   /* Length is 24. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_REG_LOAD. */
    pag_be16 ofs_nbits;             /* (ofs << 6) | (n_bits - 1). */
    pag_be32 dst;                   /* Destination register. */
    pag_be64 value;                 /* Immediate value. */
};
...
struct nx_action_stack {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_STACK_PUSH or NXAST_STACK_POP. */
    pag_be16 offset;                /* Bit offset into the field. */
    pag_be32 field;                 /* The field used for push or pop. */
    pag_be16 n_bits;                /* (n_bits + 1) bits of the field. */
...
struct nx_action_note {
    pag_be16 type;                  /* OFPAT_VENDOR. */
    pag_be16 len;                   /* A multiple of 8, but at least 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_NOTE. */
...
struct nx_action_multipath {
    pag_be16 type;              /* OFPAT_VENDOR. */
    pag_be16 len;               /* Length is 32. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_MULTIPATH. */

    /* What fields to hash and how. */
    pag_be16 fields;            /* One of NX_HASH_FIELDS_*. */
    pag_be16 basis;             /* Universal hash parameter. */
    pag_be16 pad0;

    /* Multipath link choice algorithm to apply to hash value. */
    pag_be16 algorithm;         /* One of NX_MP_ALG_*. */
    pag_be16 max_link;          /* Number of output links, minus 1. */
    pag_be32 arg;               /* Algorithm-specific argument. */
    pag_be16 pad1;

    /* Where to store the result. */
    pag_be16 ofs_nbits;         /* (ofs << 6) | (n_bits - 1). */
    pag_be32 dst;               /* Destination. */
};
 ...
 *     constant values.)
 *
 *     The source specification is an pag_be32 'field' and an pag_be16 'ofs'.
 ...
 * pag_be32 'field' and an pag_be16 'ofs'.  'field' is an nxm_header with
 ...
 * value, PAG adds a NXAST_FIN_TIMEOUT action, with the specified timeouts, to
 * the learned flow.
 *
 * Examples
 * --------
 ...
 *
 *    Match on in_port=99:
 *       pag_be16(src=1, dst=0, n_bits=16),               20 10
 *       pag_be16(99),                                    00 63
 *       pag_be32(NXM_OF_IN_PORT), pag_be16(0)            00 00 00 02 00 00
 *
 *    Match Ethernet destination on Ethernet source from packet:
 *       pag_be16(src=0, dst=0, n_bits=48),               00 30
 *       pag_be32(NXM_OF_ETH_SRC), pag_be16(0)            00 00 04 06 00 00
 *       pag_be32(NXM_OF_ETH_DST), pag_be16(0)            00 00 02 06 00 00
 *
 *    Set NXM_NX_REG1[16:31] to the packet's input port:
 *       pag_be16(src=0, dst=1, n_bits=16),               08 10
 *       pag_be32(NXM_OF_IN_PORT), pag_be16(0)            00 00 00 02 00 00
 *       pag_be32(NXM_NX_REG1), pag_be16(16)              00 01 02 04 00 10
 *
 ...
 *
 *    In syntax accepted by pag-ofctl, this action is: learn(in_port=99,
 *    NXM_OF_ETH_DST[]=NXM_OF_ETH_SRC[],
 ...
 *       pag_be16(src=0, dst=0, n_bits=12),               00 0c
 *       pag_be32(NXM_OF_VLAN_TCI), pag_be16(0)           00 00 08 02 00 00
 *       pag_be32(NXM_OF_VLAN_TCI), pag_be16(0)           00 00 08 02 00 00
 *
 *    Match Ethernet destination on Ethernet source from packet:
 *       pag_be16(src=0, dst=0, n_bits=48),               00 30
 ...
 *       pag_be16(src=0, dst=2, n_bits=16),               10 10
 *       pag_be32(NXM_OF_IN_PORT), pag_be16(0)            00 00 00 02 00 00
 *
 ...
 *    actions=output:A".
 *
 *    In syntax accepted by pag-ofctl, this action is:
 ...
 *
 *      pag-vsctl del-controller br0
 *      pag-ofctl del-flows br0
 *      pag-ofctl add-flow br0 "table=0 actions=learn(table=1, \
          hard_timeout=10, NXM_OF_VLAN_TCI[0..11],             \
          NXM_OF_ETH_DST[]=NXM_OF_ETH_SRC[],                   \
          output:NXM_OF_IN_PORT[]), resubmit(,1)"
 *      pag-ofctl add-flow br0 "table=1 priority=0 actions=flood"
 *
 *    You can then dump the MAC learning table with:
 *
 *      pag-ofctl dump-flows br0 table=1
 *
 * Usage Advice
 * ------------
 *
...
struct nx_action_learn {
    pag_be16 type;              /* OFPAT_VENDOR. */
    pag_be16 len;               /* At least 24. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_LEARN. */
    pag_be16 idle_timeout;      /* Idle time before discarding (seconds). */
    pag_be16 hard_timeout;      /* Max time before discarding (seconds). */
    pag_be16 priority;          /* Priority level of flow entry. */
    pag_be64 cookie;            /* Cookie for new flow. */
    pag_be16 flags;             /* Either 0 or OFPFF_SEND_FLOW_REM. */
    uint8_t table_id;           /* Table to insert flow entry. */
    uint8_t pad;                /* Must be zero. */
    pag_be16 fin_idle_timeout;  /* Idle timeout after FIN, if nonzero. */
    pag_be16 fin_hard_timeout;  /* Hard timeout after FIN, if nonzero. */
...
struct nx_action_fin_timeout {
    ...
    pag_be16 len;               /* 16. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_FIN_TIMEOUT. */
    pag_be16 fin_idle_timeout;  /* New idle timeout, if nonzero. */
    pag_be16 fin_hard_timeout;  /* New hard timeout, if nonzero. */
    pag_be16 pad;               /* Must be zero. */
};
...
struct nx_action_bundle {
    pag_be16 type;              /* OFPAT_VENDOR. */
    pag_be16 len;               /* Length including slaves. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_BUNDLE or NXAST_BUNDLE_LOAD. */

    /* Slave choice algorithm to apply to hash value. */
    pag_be16 algorithm;         /* One of NX_BD_ALG_*. */

    /* What fields to hash and how. */
    pag_be16 fields;            /* One of NX_HASH_FIELDS_*. */
    pag_be16 basis;             /* Universal hash parameter. */

    pag_be32 slave_type;        /* NXM_OF_IN_PORT. */
    pag_be16 n_slaves;          /* Number of slaves. */
...
struct nx_action_cnt_ids {
    ...
    pag_be16 len;               /* Length including slaves. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_DEC_TTL_CNT_IDS. */

    pag_be16 n_controllers;     /* Number of controllers. */
...
struct nx_action_output_reg {
    ...
    pag_be16 len;               /* 24. */
    pag_be32 vendor;            /* NX_VENDOR_ID. */
    pag_be16 subtype;           /* NXAST_OUTPUT_REG. */

    pag_be16 ofs_nbits;         /* (ofs << 6) | (n_bits - 1). */
    pag_be32 src;               /* Source. */

    pag_be16 max_len;           /* Max length to send to controller. */
 ...
 */
struct nx_flow_mod {
    pag_be64 cookie;              /* Opaque controller-issued identifier. */
    pag_be16 command;             /* OFPFC_* + possibly a table ID (see comment
                                   * on struct nx_flow_mod_table_id). */
    pag_be16 idle_timeout;        /* Idle time before discarding (seconds). */
    pag_be16 hard_timeout;        /* Max time before discarding (seconds). */
    pag_be16 priority;            /* Priority level of flow entry. */
    pag_be32 buffer_id;           /* Buffered packet to apply to (or -1).
                                     Not meaningful for OFPFC_DELETE*. */
    pag_be16 out_port;            /* For OFPFC_DELETE* commands, require
                                     matching entries to include this as an
                                     output port.  A value of OFPP_NONE
                                     indicates no restriction. */
    pag_be16 flags;               /* One of OFPFF_*. */
    pag_be16 match_len;           /* Size of nx_match. */
    uint8_t pad[6];               /* Align to 64-bits. */
    /* Followed by:
     *   - Exactly match_len (possibly 0) bytes containing the nx_match, then
...
struct nx_flow_removed {
    ...
    pag_be32 duration_sec;    /* Time flow was alive in seconds. */
    pag_be32 duration_nsec;   /* Time flow was alive in nanoseconds beyond
                                 duration_sec. */
    pag_be16 idle_timeout;    /* Idle timeout from original flow mod. */
    pag_be16 match_len;       /* Size of nx_match. */
    pag_be64 packet_count;
    pag_be64 byte_count;
    /* Followed by:
     *   - Exactly match_len (possibly 0) bytes containing the nx_match, then
     *   - Exactly (match_len + 7)/8*8 - match_len (between 0 and 7) bytes of
...
struct nx_flow_stats_request {
    pag_be16 out_port;        /* Require matching entries to include this
                                 as an output port.  A value of OFPP_NONE
                                 indicates no restriction. */
    pag_be16 match_len;       /* Length of nx_match. */
...
struct nx_flow_stats {
    pag_be16 length;          /* Length of this entry. */
    uint8_t table_id;         /* ID of table flow came from. */
    uint8_t pad;
    pag_be32 duration_sec;    /* Time flow has been alive in seconds. */
    pag_be32 duration_nsec;   /* Time flow has been alive in nanoseconds
                                 beyond duration_sec. */
    pag_be16 priority;        /* Priority of the entry. */
    pag_be16 idle_timeout;    /* Number of seconds idle before expiration. */
    pag_be16 hard_timeout;    /* Number of seconds before expiration. */
    pag_be16 match_len;       /* Length of nx_match. */
    pag_be16 idle_age;        /* Seconds since last packet, plus one. */
    pag_be16 hard_age;        /* Seconds since last modification, plus one. */
    pag_be64 cookie;          /* Opaque controller-issued identifier. */
    pag_be64 packet_count;    /* Number of packets, UINT64_MAX if unknown. */
    pag_be64 byte_count;      /* Number of bytes, UINT64_MAX if unknown. */
    /* Followed by:
     *   - Exactly match_len (possibly 0) bytes containing the nx_match, then
     *   - Exactly (match_len + 7)/8*8 - match_len (between 0 and 7) bytes of
     *     all-zero bytes, then
...
struct nx_controller_id {
    ...
    pag_be16 controller_id;     /* New controller connection ID. */
};
...
struct nx_action_controller {
    ...
    pag_be16 len;                   /* Length is 16. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_CONTROLLER. */
    pag_be16 max_len;               /* Maximum length to send to controller. */
    pag_be16 controller_id;         /* Controller ID to send packet-in. */
 ...
 * PAG reacts as follows:
 *
 * 1. PAG sends an NXT_FLOW_MONITOR_PAUSED message to the controller, following
 ...
 *          that existed before PAG sent NXT_FLOW_MONITOR_PAUSED.
 *
 ...
 *
 * 3. When the notification buffer empties, PAG sends NXFME_ADD notifications
 ...
 *
 * 4. PAG sends an NXT_FLOW_MONITOR_RESUMED message to the controller.  After
...
struct nx_flow_monitor_request {
    pag_be32 id;                /* Controller-assigned ID for this monitor. */
    pag_be16 flags;             /* NXFMF_*. */
    pag_be16 out_port;          /* Required output port, if not OFPP_NONE. */
    pag_be16 match_len;         /* Length of nx_match. */
 ...
 * NXFME_MODIFIED. */
struct nx_flow_update_full {
    pag_be16 length;            /* Length is 24. */
    pag_be16 event;             /* One of NXFME_*. */
    pag_be16 reason;            /* OFPRR_* for NXFME_DELETED, else zero. */
    pag_be16 priority;          /* Priority of the entry. */
    pag_be16 idle_timeout;      /* Number of seconds idle before expiration. */
    pag_be16 hard_timeout;      /* Number of seconds before expiration. */
    pag_be16 match_len;         /* Length of nx_match. */
 ...
 *
 * PAG will always send the notifications for a given flow table change before
...
struct nx_flow_update_abbrev {
    pag_be16 length;            /* Length is 8. */
    pag_be16 event;             /* NXFME_ABBREV. */
    pag_be32 xid;               /* Controller-specified xid from flow_mod. */
};
...
struct nx_flow_monitor_cancel {
    pag_be32 id;                /* 'id' from nx_flow_monitor_request. */
};
...
struct nx_action_write_metadata {
    ...
    pag_be16 len;                   /* Length is 32. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_WRITE_METADATA. */
    uint8_t zeros[6];               /* Must be zero. */
    pag_be64 metadata;              /* Metadata register. */
    pag_be64 mask;                  /* Metadata mask. */
};
...
struct nx_action_push_mpls {
    pag_be16 type;                  /* OFPAT_VENDOR. */
    pag_be16 len;                   /* Length is 8. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_PUSH_MPLS. */
    pag_be16 ethertype;             /* Ethertype */
    uint8_t  pad[4];
};
...
struct nx_action_pop_mpls {
    ...
    pag_be16 len;                   /* Length is 8. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_POP_MPLS. */
    pag_be16 ethertype;             /* Ethertype */
    uint8_t  pad[4];
};
...
struct nx_action_mpls_label {
    ...
    pag_be16 len;                   /* Length is 8. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_MPLS_LABEL. */
    uint8_t  zeros[2];               /* Must be zero. */
    pag_be32 label;                 /* LABEL */
};
...
struct nx_action_mpls_tc {
    ...
    pag_be16 len;                   /* Length is 8. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_MPLS_TC. */
    uint8_t  tc;                    /* TC */
    uint8_t  pad[5];
};
...
struct nx_action_mpls_ttl {
    ...
    pag_be16 len;                   /* Length is 8. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SET_MPLS_TTL. */
    uint8_t  ttl;                   /* TTL */
    uint8_t  pad[5];
};
...
struct nx_action_sample {
    ...
    pag_be16 len;                   /* Length is 24. */
    pag_be32 vendor;                /* NX_VENDOR_ID. */
    pag_be16 subtype;               /* NXAST_SAMPLE. */
    pag_be16 probability;           /* Fraction of packets to sample. */
    pag_be32 collector_set_id;      /* ID of collector set in PAGDB. */
    pag_be32 obs_domain_id;         /* ID of sampling observation domain. */
    pag_be32 obs_point_id;          /* ID of sampling observation point. */
};
